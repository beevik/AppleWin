...
void CPropertySheet::Init(void) {
    ...
    PropSheetPages[PG_CONFIG].pfnDlgProc = (DLGPROC)PageConfig::DlgProc;
    ...
    PropSheetPages[PG_INPUT].pfnDlgProc = (DLGPROC)PageInput::DlgProc;
    ...
    PropSheetPages[PG_SOUND].pfnDlgProc = (DLGPROC)PageSound::DlgProc;
    ...
    PropSheetPages[PG_DISK].pfnDlgProc = (DLGPROC)PageDisk::DlgProc;
    ...
    PropSheetPages[PG_ADVANCED].pfnDlgProc = (DLGPROC)PageAdvanced::DlgProc;
