...
constexpr double _14M_NTSC = (157500000.0 / 11.0);  // 14.3181818... * 10^6
constexpr double _14M_PAL = 14.25045e6;             // UTAIIe:3-17
constexpr double CLK_6502_NTSC = (_14M_NTSC * 65.0) / (65.0 * 14.0 + 2.0); // 65 cycles per 912 14M clocks
constexpr double CLK_6502_PAL = (_14M_PAL * 65.0) / (65.0 * 14.0 + 2.0);
...
constexpr DWORD SPKR_SAMPLE_RATE = 44100;
...
#define  REGVALUE_CONFIRM_REBOOT            "Confirm Reboot"
...
#define  REGVALUE_JOYSTICK0_EMU_TYPE        "Joystick0 Emu Type v3" 
#define  REGVALUE_JOYSTICK1_EMU_TYPE        "Joystick1 Emu Type v3" 
#define  REGVALUE_OLD_JOYSTICK0_EMU_TYPE2   "Joystick0 Emu Type"    
#define  REGVALUE_OLD_JOYSTICK1_EMU_TYPE2   "Joystick1 Emu Type"    
#define  REGVALUE_OLD_JOYSTICK0_EMU_TYPE1   "Joystick 0 Emulation"  
#define  REGVALUE_OLD_JOYSTICK1_EMU_TYPE1   "Joystick 1 Emulation"  
...
#define  REGVALUE_VIDEO_STYLE               "Video Style"
...
inline bool IsApple2Original(eApple2Type type) {
    return type == A2TYPE_APPLE2;
}

inline bool IsApple2Plus(eApple2Type type) {
...
inline bool IsApple2PlusOrClone(eApple2Type type) {
...
enum {
    IDEVENT_TIMER_MOUSE = 1,
    IDEVENT_TIMER_100MSEC
};
